			...
			<div style={{backgroundColor: "#fff"}}>
				<Container className="MainInfoPanel">
					...
					<MainInfo title={"Nocleg"}
						text={"Dla rodziny spoza Warszawy i spoza okolic organizujemy nocleg w Hotelu Panorama. Hotel znajduje się przy ul. Tarczyńskiej 109A w Mszczonowie - 5min drogi samochodem od karczmy. Rano zapraszamy na śniadanie w hotelu. Przed ślubem będzie możliwość przyjechania do hotelu celem zostawienia bagaży."}
					/>
